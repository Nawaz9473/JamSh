...
export type NotificationType = 'MESSAGE' | 'THUNDER' | 'LIKE' | 'COMMENT' | 'REPLY' | 'FOLLOW' | 'FOLLOW_REQUEST' | 'FOLLOW_ACCEPTED' | 'MENTION' | 'TAG' | 'SHARE' | 'BOOKMARK' | 'COMMUNITY' | 'EVENT' | 'SYSTEM' | 'SECURITY' | 'AI_RECOMMENDATION';
