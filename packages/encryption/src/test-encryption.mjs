...
import { generateKeyPair, deriveSharedSecret, deriveAESKey, encryptWithKey, decryptWithKey } from '../dist/index.js';

async function runTests() {
  console.log('⚡ Starting JAMSH Encryption Suite Tests (ESM)...');
