...
export const ThunderButton = ({ isThundered, thunderCount, onPress, size = 24, }) => {
    ...
    return (_jsxs(TouchableOpacity, { activeOpacity: 0.7, onPress: handlePress, style: styles.container, children: [_jsxs(View, { style: styles.iconContainer, children: [particles.map((p) => (_jsx(Animated.View, { style: [
                            styles.particle,
                            {
                                transform: [
                                    { translateX: p.x },
                        ...
                        ] }, p.id))), _jsx(Animated.View, { style: [
                            styles.thunderIconWrapper,
                            {
                                transform: [{ scale: scaleAnim }, { rotate: rotateInterpolation }],
                            },
                        ], children: _jsx(View, { style: [styles.boltContainer, { width: size, height: size * 1.5 }], children: _jsx(Text, { style: [
                                    styles.boltText,
                                    {
                                        fontSize: size,
                ...
                ], children: [thunderCount, " ", thunderCount === 1 ? 'Thunder' : 'Thunders'] })] }));
};
